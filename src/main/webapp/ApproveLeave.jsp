...
<form method="post" action="ApproveRejectBack" >
  ...
  <input class="form-check-input" type="radio" name="Decision" id="flexRadioDefault1" value="Approve" onclick="getValue('Approved')">
  <label class="form-check-label" for="flexRadioDefault1" >
    Approve
  </label>
  </div >
  <div class="form-check">
    <input class="form-check-input" type="radio" name="Decision" id="flexRadioDefault1" value="Reject" onclick="getValue('Rejected')">
   <label class="form-check-label" for="flexRadioDefault1" >
    Reject
  </label>
  </div>
