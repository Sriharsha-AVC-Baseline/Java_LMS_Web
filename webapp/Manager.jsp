...
<h3 class="display-4" style="text-align: center;">Welcome <%= name %>, you are logged in as <%= designation %> </h3>
   ...
   <br>
   <a style="text-decoration: none;" href="applyeave?name=<%=name%>&pass=<%=pass %>"><button type="button" class="btn btn-primary btn-lg" style="margin-left:10px">Apply For leave</button></a>
   </div>
   <br><br>
