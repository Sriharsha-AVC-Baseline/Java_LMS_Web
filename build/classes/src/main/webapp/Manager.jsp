...
<div class="dropdown">
<button id="round"  onclick="showHide('content')"> &nbsp; <%= Character.toUpperCase(name.charAt(0)) %> &nbsp; </button>
<div class="content" id="content" style="visibility: hidden;">
<ul style="list-style: none;text-align: right;" id="list" >
<li><%= name %></li>
<li><%= designation %></li>
<li><a href="#" onclick="showHide('leavedetails')">Check my leaves</a></li>
<li><a href="#" onclick="showHide('leaveRecords')">Check my leave Records</a></li>
...
<br><br>
<h3 class="display-4" style="text-align: center;">Welcome <%= name %>, you are logged in as <%= designation %> </h3>
	
	<br><br>
	<div class='center'>
	
	<h2>Common Employee Options : &nbsp;</h2>
   ...
   <br>
   <a style="text-decoration: none;" href="ApplyLeave?name=<%=name%>&pass=<%=pass %>"><button type="button" class="btn btn-primary btn-lg" style="margin-left:10px">Apply For leave</button></a>
   </div>
   <br><br>
   <h2>Higher management Options : &nbsp;</h2>
   <div style="display: flex;">
   <a style="text-decoration: none; margin-left: 20px;" href="employee"><button type="button" class="btn btn-primary btn-lg">Generate employee list</button></a>
   
   <div style="display: flex;">
   <a style="text-decoration: none; margin-left: 20px;" href="approveRejectLeave"><button type="button" class="btn btn-primary btn-lg">Approve/Reject Leaves</button></a>
	<a style="text-decoration: none; margin-left: 20px;" href="RevokeLeave"><button type="button" class="btn btn-primary btn-lg">Revoke Leaves</button></a>
