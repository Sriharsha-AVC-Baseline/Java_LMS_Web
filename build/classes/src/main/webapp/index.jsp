...
<body style="text-align: center;">
	...
	<div class="container">
		<div>
			...
			<form method="post" action="Login" style="text-align: left;">
				<div class="form-group">
					<label for="name" style="text-align: left;">UserID:</label> <input
		...
		<br/>
		<h6 style="text-align:center;">Note : Your UserID will be Your full name(along with space) + First letter of your Designation (Uppercase) + month of your birth + year of your birth</h6>
