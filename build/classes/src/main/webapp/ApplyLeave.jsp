...
<%String menu = "<h1 class=\"display-6\" style=\"background-color: lime;height:20%;text-align:center\">Welcome InTimeTec</h1>";
	...
	int numberOfLeaves = (int)request.getAttribute("numberOfLeaves");
%>
<style>
	.form-group{
	width:60%;
...
document.getElementById("date2").addEventListener("change",function()
	...
	const arraySec = selectedLeave.split(" ");
	const numberOfLeavesLeft = parseInt(arraySec[1]);
	...
	if(numberOfDays > numberOfLeavesLeft)
		{
		alert("You Don't have "+numberOfDays+" of leaves, "+numberOfLeavesLeft+"days left");
